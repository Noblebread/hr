<div class="content">
						...
						<div class="row align-items-center">
							<div class="col">
								<div class="doctor-table-blk">
									<h3>Departure List</h3>
									<div class="doctor-search-blk">
										<div class="doctor-search-blk">
											<div class="add-group">
												<a wire:click="createDeparture" class="btn btn-primary ms-2"><img src="{{ asset('assets/img/icons/plus.svg') }}" alt>
												</a>
											</div>
										</div>
									</div>
						...
						<table class="table border-0 custom-table comman-table datatable mb-0">
							<thead>
								<tr>
									...
									<th>Type</th>
									<th>department</th>
									<th>Date scheduled to leave</th>
									<th>Date scheduled to return</th>
                                    <th>Action</th>
								</tr>
							</thead>
							<tbody>
	...
	<div wire.ignore.self class="modal fade" id="departureModal" tabindex="-1" role="dialog" aria-labelledby="departureModal" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
		<div class="modal-dialog modal-dialog-centered">
			<livewire:departure.departure-form />
		</div>
	</div>
</div>

@section('custom_script')
@include('layouts.scripts.departure-scripts')
@endsection