<div class="content">
							...
							<div class="col">
								<div class="doctor-table-blk">
									...
									<div class="doctor-search-blk">
										<div class="doctor-search-blk">
											<div class="add-group">
												<a wire:click="createStorage" class="btn btn-primary ms-2"><img src="{{ asset('assets/img/icons/plus.svg') }}" alt>
												</a>
											</div>
										</div>
									</div>
	...
	<div wire.ignore.self class="modal fade" id="storageModal" tabindex="-1" role="dialog" aria-labelledby="storageModal" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
		<div class="modal-dialog modal-dialog-centered">
			<livewire:storage.storage-form />
		</div>
	</div>
</div>

@section('custom_script')
@include('layouts.scripts.storage-scripts')
@endsection