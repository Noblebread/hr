<div class="content">
							...
							<div class="col">
								<div class="doctor-table-blk">
									...
									<div class="doctor-search-blk">
										<div class="doctor-search-blk">
											<div class="add-group">
												<a wire:click="createAttendance" class="btn btn-primary ms-2"><img src="{{ asset('assets/img/icons/plus.svg') }}" alt>
												</a>
	...
	<div wire.ignore.self class="modal fade" id="attendanceModal" tabindex="-1" role="dialog" aria-labelledby="attendanceModal" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
...
@include('layouts.scripts.attendance-scripts')
@endsection